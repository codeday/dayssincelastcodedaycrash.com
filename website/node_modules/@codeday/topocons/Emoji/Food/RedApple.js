...
var SvgRedApple = function SvgRedApple(props) {
  return _react["default"].createElement("svg", _extends({
    ...
    fill: "url(#red-apple_svg__a)",
    d: "M31.873 13.657C29.564 13.657 3 4.854 3 29.919 3 45.134 18.711 62 25.568 62c3.111 0 4.5-1.996 6.305-1.996 1.838 0 2.158 1.996 6.141 1.996C44.873 62 61 43.387 61 29.919c0-25.09-26.818-16.262-29.127-16.262z"
    ...
    fill: "url(#red-apple_svg__c)",
    d: "M32.453 26.574c-1.338-8.037-8.838-13.924-16.747-13.149-7.915.773-13.245 7.914-11.907 15.951 1.34 8.038 8.84 13.925 16.752 13.15 7.913-.772 13.242-7.915 11.902-15.952z"
  }), _react["default"].createElement("path", {
    fill: "#449C00",

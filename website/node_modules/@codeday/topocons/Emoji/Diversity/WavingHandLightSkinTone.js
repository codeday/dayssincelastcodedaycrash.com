...
var SvgWavingHandLightSkinTone = function SvgWavingHandLightSkinTone(props) {
  return _react["default"].createElement("svg", _extends({
    ...
    id: "waving-hand-light-skin-tone_svg__a",
    cx: 382.594,
    cy: -671.978,
    r: 46.136,
    ...
    fill: "url(#waving-hand-light-skin-tone_svg__a)",
    d: "M49.982 12.255c-5.934 6.246-.643 12.668-3.805 13.037-.822.092-3.168-2.602-3.168-2.602-4.031-4.242-9.648-10.017-17.977-18.449-4.188-4.244-10.426 2.066-6.232 6.314l-3.226-3.272C11.388 3.046 5.115 9.324 9.34 13.597c1.129 1.144 2.197 2.228 3.229 3.271-4.184-4.234-10.418 2.078-6.236 6.313.893.904 2.945 2.98 5.367 5.436-4.352-4.039-9.428 1.285-5.395 5.658 4.59 4.975 14.027 14.988 19.082 20.092 7.246 7.314 18.063 9.848 25.932 1.57 17.109-17.998.375-26.266 4.678-43.6.53-2.146-3.052-3.197-6.015-.082z"
  }), _react["default"].createElement("path", {
    fill: "#0FB4D4",
...
var _default = SvgWavingHandLightSkinTone;
